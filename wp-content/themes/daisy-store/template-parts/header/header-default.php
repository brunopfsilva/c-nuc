  <br/><div class="cactus-header cactus-classic-header right">
                        ...
                        <div class="cactus-microwidget cactus-search-full">
                            <form role="search" class="searchform searchform-cats" method="get" action="<?php echo esc_url( home_url( '/'  ) );?>">
                                <div>
                                    ...
                                    <input type="text" class="search-field" placeholder="<?php esc_attr_e('Pesquisar','daisy-store');?> ..." value="<?php echo get_search_query(); ?>" name="s">
								...
								$args = array(
								  ...
								  'show_option_all' => esc_attr__('Todas Categorias','daisy-store'),
								...
								?>
                                    <input type="submit" class="search-submit" value="<?php esc_attr_e('Pesquisar','daisy-store');?>">
                                </div>                                    
                            </form>
                        </div>
                    </div>
