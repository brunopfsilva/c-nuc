...
<p><?php _e( 'A new auction product is submitted to your site', 'dokan-lite' ); ?> <a href="<?php echo $data['site_url'] ?>" ><?php echo $data['site_name'] ?></a> </p>
...
<ul>
    ...
    <li>
        <strong>
            <?php _e( 'Selling Price :', 'dokan-lite' ); ?>
        </strong>
